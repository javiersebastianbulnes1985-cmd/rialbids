<x-guest-layout>
  ...
  <div style="display:flex;flex-direction:column;gap:10px;margin-bottom:20px;">
    <a href="{{ route('auth.google') }}" style="display:flex;align-items:center;justify-content:center;gap:10px;padding:11px;border:1.5px solid #e5e7eb;border-radius:8px;font-size:14px;font-weight:500;color:#111827;text-decoration:none;background:#fff;">
    ...
    <a href="{{ route('auth.facebook') }}" style="display:flex;align-items:center;justify-content:center;gap:10px;padding:11px;border-radius:8px;font-size:14px;font-weight:500;color:#fff;text-decoration:none;background:#1877F2;">
  ...
  <form method="POST" action="{{ route('login') }}">
    ...
    <div style="margin-bottom:16px;">
      ...
      <input style="width:100%;padding:10px 14px;border:1.5px solid #e5e7eb;border-radius:8px;font-size:14px;outline:none;box-sizing:border-box;" type="email" name="email" value="{{ old('email') }}" required autofocus placeholder="tu@email.com">
