...
<table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;max-width:560px;box-shadow:0 2px 8px rgba(0,0,0,0.06)">
  ...
  <tr><td style="padding:32px">
    <p style="font-size:16px;color:#111827;margin:0 0 16px;font-weight:600">Hola {{ $user->name }},</p>
    @if($destinatario === 'comprador' && $favor === 'comprador')
      <p style="font-size:15px;color:#374151;line-height:1.6;margin:0 0 16px">Revisamos tu disputa del lote <strong>"{{ $titulo }}"</strong> y la resolvimos <strong style="color:#16a34a">a tu favor</strong>.</p>
    ...
    @elseif($destinatario === 'comprador' && $favor === 'vendedor')
      <p style="font-size:15px;color:#374151;line-height:1.6;margin:0 0 16px">Revisamos con atencion tu disputa del lote <strong>"{{ $titulo }}"</strong>.</p>
    ...
    @elseif($destinatario === 'vendedor' && $favor === 'vendedor')
      <p style="font-size:15px;color:#374151;line-height:1.6;margin:0 0 16px">La disputa del lote <strong>"{{ $titulo }}"</strong> se resolvio <strong style="color:#16a34a">a tu favor</strong>.</p>
    ...
    @else
      <p style="font-size:15px;color:#374151;line-height:1.6;margin:0 0 16px">La disputa del lote <strong>"{{ $titulo }}"</strong> se resolvio a favor del comprador.</p>
