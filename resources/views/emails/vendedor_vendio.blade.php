...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;max-width:600px;box-shadow:0 2px 8px rgba(0,0,0,0.08)">
  ...
  <tr><td style="padding:32px">
    ...
    <p style="font-size:15px;color:#374151;margin:0 0 24px">Buenas noticias: tu lote <strong>{{ $auction->title }}</strong> se vendio. Aca tenes el detalle de lo que vas a cobrar.</p>
    ...
    <div style="background:#f5f3ef;border-left:4px solid #c9a84c;border-radius:0 4px 4px 0;padding:20px;margin-bottom:24px">
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr><td style="font-size:14px;color:#374151;padding:4px 0">Precio de venta</td><td style="font-size:14px;color:#374151;text-align:right;padding:4px 0">€{{ number_format($precio, 2, ',', '.') }}</td></tr>
        <tr><td style="font-size:14px;color:#374151;padding:4px 0">Comision RialBids (9% + €3)</td><td style="font-size:14px;color:#374151;text-align:right;padding:4px 0">&minus;€{{ number_format($comision, 2, ',', '.') }}</td></tr>
        <tr><td colspan="2" style="border-top:1px solid #d6d1c4;padding-top:8px"></td></tr>
        <tr><td style="font-size:16px;font-weight:700;color:#1a3a6b;padding:4px 0">Recibis</td><td style="font-size:16px;font-weight:700;color:#1a3a6b;text-align:right;padding:4px 0">€{{ number_format($neto, 2, ',', '.') }}</td></tr>
      </table>
    </div>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px">
      <tr><td align="center">
        <a href="{{ url('/vendor') }}" style="background:#1a3a6b;color:#fff;padding:14px 32px;border-radius:8px;font-size:15px;font-weight:700;text-decoration:none;display:inline-block">Ver mi panel de vendedor</a>
      </td></tr>
    </table>
  </td></tr>
