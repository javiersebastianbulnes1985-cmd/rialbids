...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;max-width:600px;box-shadow:0 2px 8px rgba(0,0,0,0.08)">
  ...
  <tr><td style="padding:32px">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px">
      <tr><td align="center">
        <a href="{{ url('/') }}" style="background:#1a3a6b;color:#fff;padding:14px 32px;border-radius:8px;font-size:15px;font-weight:700;text-decoration:none;display:inline-block;border-bottom:3px solid #c9a84c">Ver subastas en vivo</a>
      </td></tr>
    </table>
    @if($subastas->count() > 0)
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td style="width:50%;padding:0 8px 16px;vertical-align:top">
          ...
          <p style="font-size:14px;color:#c9a84c;font-weight:700;margin:0 0 8px">EUR {{ number_format($s->current_price,0,',','.') }}</p>
