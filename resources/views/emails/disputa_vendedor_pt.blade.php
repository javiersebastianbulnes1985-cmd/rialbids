...
<table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;max-width:560px;box-shadow:0 2px 8px rgba(0,0,0,0.06)">
  ...
  <tr><td style="padding:32px">
    ...
    <p style="font-size:15px;color:#374151;line-height:1.6;margin:0 0 16px">Um comprador abriu uma disputa sobre o seu lote <strong>"{{ $titulo }}"</strong>.</p>
    <p style="font-size:14px;color:#374151;line-height:1.6;margin:0 0 6px"><strong>Motivo:</strong> {{ $dispute->reason }}</p>
    ...
    @endif
    <p style="font-size:15px;color:#374151;line-height:1.6;margin:0 0 16px">Antes de tomar uma decisao, queremos ouvir a sua versao. Tem <strong>3 dias</strong> para responder com a sua defesa. Se nao responder, resolveremos com a informacao disponivel.</p>
    <table cellpadding="0" cellspacing="0" style="margin:8px 0 24px"><tr><td style="background:#1a3a6b;border-radius:8px"><a href="{{ url('/vendor') }}" style="display:inline-block;padding:12px 28px;color:#fff;font-size:15px;font-weight:600;text-decoration:none">Responder a disputa</a></td></tr></table>
    <p style="font-size:14px;color:#6b7280;line-height:1.6;margin:0 0 24px">Entretanto, o pagamento desta operacao fica retido ate resolver a situacao.</p>
