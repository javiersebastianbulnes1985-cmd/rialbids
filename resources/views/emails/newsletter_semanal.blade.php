...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;max-width:600px;box-shadow:0 2px 8px rgba(0,0,0,0.08)">
  ...
  <tr><td style="padding:32px">
    ...
    <p style="font-size:15px;color:#374151;margin:0 0 24px">Esta semana tenemos {{ count($auctions) }} lotes nuevos esperandote.</p>
    <table width="100%" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td style="width:50%;padding:0 {{ $loop->parent->first ? '' : '' }}{{ $loop->first ? '8px 12px 0 0' : '8px 0 0 12px' }};vertical-align:top">
          ...
          <a href="{{ url('/auctions/'.$a->id) }}" style="background:#1a3a6b;color:#fff;padding:6px 14px;border-radius:6px;font-size:12px;font-weight:600;text-decoration:none">Ver lote</a>
        </td>
        @endforeach
