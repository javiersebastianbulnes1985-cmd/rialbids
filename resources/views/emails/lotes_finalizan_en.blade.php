...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;max-width:600px;box-shadow:0 2px 8px rgba(0,0,0,0.08)">
  ...
  <tr><td style="background:#1a3a6b;padding:28px 32px;text-align:center">
    <h1 style="color:#c9a84c;font-size:22px;font-weight:700;margin:0 0 8px;font-family:Georgia,serif">These auctions are closing</h1>
    <p style="color:#e8e4d9;font-size:15px;margin:0">Don't miss out — bids are binding.</p>
  </td></tr>
  <tr><td style="padding:32px">
    <h2 style="font-size:20px;font-weight:700;color:#1a3a6b;margin:0 0 8px">Hola {{ $user->name }},</h2>
    <p style="font-size:15px;color:#374151;margin:0 0 24px">These lots close in less than 48 hours. Don't miss out.</p>
    <table width="100%" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td style="width:50%;padding:0 {{ $loop->parent->first ? '' : '' }}{{ $loop->first ? '8px 12px 0 0' : '8px 0 0 12px' }};vertical-align:top">
          ...
          <a href="{{ url('/auctions/'.$a->id) }}" style="background:#1a3a6b;color:#fff;padding:6px 14px;border-radius:6px;font-size:12px;font-weight:600;text-decoration:none">Bid now</a>
        </td>
        @endforeach
