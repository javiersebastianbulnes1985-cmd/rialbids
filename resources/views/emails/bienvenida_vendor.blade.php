...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;max-width:600px;box-shadow:0 2px 8px rgba(0,0,0,0.08)">
  <tr><td style="background:#1a3a6b;padding:28px 32px;text-align:center">
    <a href="{{ url('/') }}" style="text-decoration:none">
      <span style="color:#fff;font-size:28px;font-weight:800;font-family:Georgia,serif;letter-spacing:-1px">Rial<span style="color:#c9a84c">Bids</span></span>
    </a>
  </td></tr>
  <tr><td style="background:#1a3a6b;padding:0 32px 28px;text-align:center">
  ...
  <tr><td style="padding:32px">
    ...
    <div style="background:#f5f3ef;border-left:4px solid #c9a84c;border-radius:4px;padding:20px;margin-bottom:24px">
      <p style="font-size:14px;font-weight:700;color:#1a3a6b;margin:0 0 16px">Como empezar:</p>
      <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:12px">
        <tr>
          <td width="44" valign="top">
            <div style="background:#c9a84c;border-radius:50%;width:32px;height:32px;line-height:32px;text-align:center;font-size:14px;font-weight:700;color:#fff">1</div>
          </td>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:12px">
        <tr>
          <td width="44" valign="top">
            <div style="background:#c9a84c;border-radius:50%;width:32px;height:32px;line-height:32px;text-align:center;font-size:14px;font-weight:700;color:#fff">2</div>
          </td>
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td width="44" valign="top">
            <div style="background:#c9a84c;border-radius:50%;width:32px;height:32px;line-height:32px;text-align:center;font-size:14px;font-weight:700;color:#fff">3</div>
          </td>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px">
      <tr><td align="center">
        <a href="{{ url('/vendor') }}" style="background:#1a3a6b;color:#fff;padding:14px 32px;border-radius:8px;font-size:15px;font-weight:700;text-decoration:none;display:inline-block;border-bottom:3px solid #c9a84c">Subir mi primer lote ahora</a>
      </td></tr>
    </table>
