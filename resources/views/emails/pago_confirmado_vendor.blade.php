...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;max-width:600px;box-shadow:0 2px 8px rgba(0,0,0,0.08)">
  ...
  <tr><td style="background:#1a3a6b;padding:28px 32px;text-align:center">
    <h1 style="color:#c9a84c;font-size:22px;font-weight:700;margin:0 0 8px;font-family:Georgia,serif">Vendiste un lote</h1>
    <p style="color:#e8e4d9;font-size:15px;margin:0">El comprador pago. Prepara el envio en los proximos 3 dias habiles.</p>
  </td></tr>
  <tr><td style="padding:32px">
    ...
    <div style="background:#f5f3ef;border-left:4px solid #c9a84c;border-radius:0 4px 4px 0;padding:20px;margin-bottom:24px">
      <p style="font-size:13px;font-weight:700;color:#1a3a6b;margin:0 0 12px;text-transform:uppercase;letter-spacing:1px">Detalle de la venta</p>
      ...
      <p style="font-size:14px;color:#374151;margin:0 0 4px">Tu ganancia neta: <strong>€{{ number_format($auction->final_price * 0.91 - 3, 2, ",", ".") }}</strong></p>
    ...
    <div style="background:#e8f5e9;border-left:4px solid #2e7d32;border-radius:0 4px 4px 0;padding:20px;margin-bottom:24px">
      <p style="font-size:14px;font-weight:700;color:#2e7d32;margin:0 0 8px">Que hacer ahora:</p>
      <p style="font-size:14px;color:#374151;margin:0 0 6px">1. Prepara el objeto con cuidado para el envio.</p>
      <p style="font-size:14px;color:#374151;margin:0 0 6px">2. Envialo con servicio de tracking en los proximos 3 dias habiles.</p>
      <p style="font-size:14px;color:#374151;margin:0 0 6px">3. Carga el numero de tracking en tu panel de vendedor.</p>
      <p style="font-size:14px;color:#374151;margin:0">4. Recibes el pago 72hs despues de que el comprador confirme la recepcion.</p>
    </div>
    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px">
      <tr><td align="center">
        <a href="{{ url(\"/vendor\") }}" style="background:#1a3a6b;color:#fff;padding:14px 32px;border-radius:8px;font-size:15px;font-weight:700;text-decoration:none;display:inline-block">Ir a mi panel de vendedor</a>
      </td></tr>
    </table>
