...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;max-width:600px;box-shadow:0 2px 8px rgba(0,0,0,0.08)">
  ...
  <tr><td style="padding:32px">
    <h2 style="font-size:20px;font-weight:700;color:#1a3a6b;margin:0 0 20px">Hola <?php echo e($user->name); ?>,</h2>
    <div style="background:#f5f3ef;border-left:4px solid #c9a84c;border-radius:0 4px 4px 0;padding:20px;margin-bottom:24px">
      ...
      <p style="font-size:15px;font-weight:700;color:#111827;margin:0 0 6px"><?php echo e($auction->title); ?></p>
      <p style="font-size:14px;color:#374151;margin:0 0 4px">Precio final: <strong>€<?php echo e(number_format($auction->final_price, 2, ",", ".")); ?></strong></p>
      <p style="font-size:14px;color:#374151;margin:0">Lote: <strong>#<?php echo e(str_pad($auction->id, 4, "0", STR_PAD_LEFT)); ?></strong></p>
    </div>
...
</html><?php /**PATH /home/u396549633/domains/rialbids.com/public_html/resources/views/emails/pago_confirmado_comprador.blade.php ENDPATH**/ ?>