...
<div style="max-width:1280px;margin:16px auto 0;padding:0 24px;">
  <div style="background:#fff;border:1px solid #e5e7eb;border-radius:10px;padding:24px 32px;display:grid;grid-template-columns:repeat(3,1fr);gap:0;">
    <div style="text-align:center;padding:8px 16px;border-right:1px solid #e5e7eb;">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="#6b7280" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24" style="margin:0 auto 8px;display:block;"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
      <div style="font-size:13px;font-weight:600;color:#111827;margin-bottom:3px;"><span>Pago seguro</span></div>
      <div style="font-size:11px;color:#9ca3af;"><span>Procesado por Stripe</span></div>
    </div>
    <div style="text-align:center;padding:8px 16px;border-right:1px solid #e5e7eb;">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="#6b7280" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24" style="margin:0 auto 8px;display:block;"><path d="M9 12l2 2 4-4"/><path d="M12 2a10 10 0 1 0 0 20A10 10 0 0 0 12 2z"/></svg>
      <div style="font-size:13px;font-weight:600;color:#111827;margin-bottom:3px;"><span>Objetos verificados</span></div>
      <div style="font-size:11px;color:#9ca3af;"><span>Revisados por expertos</span></div>
    </div>
    <div style="text-align:center;padding:8px 16px;">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="#6b7280" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24" style="margin:0 auto 8px;display:block;"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
      <div style="font-size:13px;font-weight:600;color:#111827;margin-bottom:3px;"><span>Protección al comprador</span></div>
      <div style="font-size:11px;color:#9ca3af;"><span>Garantía RialBids</span></div>
    </div>
  </div>
</div>
<div style="max-width:1280px;margin:32px auto;padding:0 24px;">
  ...
  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($catFilter || $q): ?>
    ...
    <div style="margin-bottom:32px;">
      ...
      <div style="text-align:center;padding:80px 20px;background:#fff;border-radius:12px;">
        <h2 style="font-size:18px;color:#9ca3af;margin-bottom:8px;"><?php echo e(__('No hay lotes en esta categoría')); ?></h2>
        <p style="font-size:14px;color:#9ca3af;"><?php echo e(__('Pronto agregaremos más lotes.')); ?> <a href="/" style="color:#1a56db;"><?php echo e(__('Ver todos')); ?></a></p>
      </div>
      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
  ...
  <?php else: ?>
    ...
    <div style="margin-bottom:40px;">
      ...
      <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:16px;" class="home-cards">
        <a href="/?categoria=joyas" style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px 12px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;text-decoration:none;color:#111827;" onmouseover="this.style.boxShadow='0 4px 20px rgba(0,0,0,0.10)'" onmouseout="this.style.boxShadow='none'">
          ...
          <span style="font-size:13px;font-weight:600;margin-top:10px;"><?php echo e(__('Joyería')); ?></span>
          <span style="font-size:11px;color:#9ca3af;margin-top:2px;"><?php echo e(__('Anillos, collares, pulseras')); ?></span>
        </a>
        <a href="/?categoria=arte" style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px 12px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;text-decoration:none;color:#111827;" onmouseover="this.style.boxShadow='0 4px 20px rgba(0,0,0,0.10)'" onmouseout="this.style.boxShadow='none'">
          ...
          <span style="font-size:13px;font-weight:600;margin-top:10px;"><?php echo e(__('Arte')); ?></span>
          <span style="font-size:11px;color:#9ca3af;margin-top:2px;"><?php echo e(__('Pinturas, esculturas')); ?></span>
        </a>
        <a href="/?categoria=relojes" style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px 12px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;text-decoration:none;color:#111827;" onmouseover="this.style.boxShadow='0 4px 20px rgba(0,0,0,0.10)'" onmouseout="this.style.boxShadow='none'">
          ...
          <span style="font-size:13px;font-weight:600;margin-top:10px;"><?php echo e(__('Relojes')); ?></span>
          <span style="font-size:11px;color:#9ca3af;margin-top:2px;"><?php echo e(__('Vintage y de lujo')); ?></span>
        </a>
        <a href="/?categoria=muebles" style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px 12px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;text-decoration:none;color:#111827;" onmouseover="this.style.boxShadow='0 4px 20px rgba(0,0,0,0.10)'" onmouseout="this.style.boxShadow='none'">
          ...
          <span style="font-size:13px;font-weight:600;margin-top:10px;"><?php echo e(__('Antigüedades')); ?></span>
          <span style="font-size:11px;color:#9ca3af;margin-top:2px;"><?php echo e(__('Muebles y decoración')); ?></span>
        </a>
        <a href="/?categoria=coleccionismo" style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:24px 12px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;text-decoration:none;color:#111827;" onmouseover="this.style.boxShadow='0 4px 20px rgba(0,0,0,0.10)'" onmouseout="this.style.boxShadow='none'">
          ...
          <span style="font-size:13px;font-weight:600;margin-top:10px;"><?php echo e(__('Coleccionismo')); ?></span>
          <span style="font-size:11px;color:#9ca3af;margin-top:2px;"><?php echo e(__('Monedas, sellos, figuras')); ?></span>
        </a>
      </div>
    </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($filtered->count() > 0): ?>
      ...
      <div style="margin-bottom:40px;">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
          <h2 style="font-size:18px;font-weight:700;color:#111;"><?php echo e(__('Más pujas')); ?></h2>
          <a href="/" style="font-size:13px;color:#1a56db;text-decoration:none;"><?php echo e(__('Mostrar todo →')); ?></a>
        </div>
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;" class="home-cards">
      ...
      <div style="margin-bottom:40px;">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
          <h2 style="font-size:18px;font-weight:700;color:#111;"><?php echo e(__('Añadido recientemente')); ?></h2>
          <a href="/" style="font-size:13px;color:#1a56db;text-decoration:none;"><?php echo e(__('Mostrar todo →')); ?></a>
        </div>
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;" class="home-cards">
      ...
      <div style="margin-bottom:40px;">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
          <h2 style="font-size:18px;font-weight:700;color:#111;"><?php echo e(__('Finaliza pronto')); ?></h2>
          <a href="/" style="font-size:13px;color:#1a56db;text-decoration:none;"><?php echo e(__('Mostrar todo →')); ?></a>
        </div>
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;" class="home-cards">
    ...
    <?php else: ?>
      <div style="text-align:center;padding:80px 20px;background:#fff;border-radius:12px;">
        <h2 style="font-size:18px;color:#9ca3af;margin-bottom:8px;"><?php echo e(__('No hay subastas activas en este momento')); ?></h2>
        <p style="font-size:14px;color:#9ca3af;"><?php echo e(__('Volvé pronto, agregamos nuevos lotes cada semana.')); ?></p>
      </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
