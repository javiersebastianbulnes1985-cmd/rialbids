...
<div style="max-width:1280px;margin:16px auto 0;padding:0 24px;">
  <div style="background:#fff;border:1px solid #e5e7eb;border-radius:10px;padding:24px 32px;display:grid;grid-template-columns:repeat(3,1fr);gap:0;">
    <div style="text-align:center;padding:8px 16px;border-right:1px solid #e5e7eb;">
      ...
      <div style="font-size:13px;font-weight:600;color:#111827;margin-bottom:3px;">Pago seguro</div>
      <div style="font-size:11px;color:#9ca3af;">Procesado por Stripe</div>
    </div>
    <div style="text-align:center;padding:8px 16px;border-right:1px solid #e5e7eb;">
      ...
      <div style="font-size:13px;font-weight:600;color:#111827;margin-bottom:3px;">Objetos verificados</div>
      <div style="font-size:11px;color:#9ca3af;">Revisados por expertos</div>
    </div>
    <div style="text-align:center;padding:8px 16px;">
      ...
      <div style="font-size:13px;font-weight:600;color:#111827;margin-bottom:3px;">Protección al comprador</div>
      <div style="font-size:11px;color:#9ca3af;">Garantía RialBids</div>
    </div>
  </div>
</div>
