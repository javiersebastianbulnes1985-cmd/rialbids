...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;max-width:600px;box-shadow:0 2px 8px rgba(0,0,0,0.08)">
  ...
  <tr><td style="background:#1a3a6b;padding:28px 32px;text-align:center">
    <h1 style="color:#c9a84c;font-size:22px;font-weight:700;margin:0 0 8px;font-family:Georgia,serif">Your seller account is ready</h1>
    <p style="color:#e8e4d9;font-size:15px;margin:0">First lot with no commission — publish today and keep 100%.</p>
  </td></tr>
  <tr><td style="padding:32px">
    <h2 style="font-size:20px;font-weight:700;color:#1a3a6b;margin:0 0 8px">Hola <?php echo e($user->name); ?>,</h2>
    <p style="font-size:15px;color:#374151;margin:0 0 24px">You can now start selling on RialBids. Your first lot is commission-free.</p>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($password)): ?>
    <div style="background:#1a3a6b;border-radius:8px;padding:20px;margin-bottom:24px">
      <p style="font-size:13px;font-weight:700;color:#c9a84c;margin:0 0 12px;text-transform:uppercase;letter-spacing:1px">Your login details</p>
      <p style="font-size:14px;color:#fff;margin:0 0 6px"><strong>Email:</strong> <?php echo e($user->email); ?></p>
      <p style="font-size:14px;color:#fff;margin:0"><strong>Password:</strong> <?php echo e($password); ?></p>
    </div>
...
<div style="background:#f5f3ef;border-left:4px solid #c9a84c;border-radius:0 4px 4px 0;padding:20px;margin-bottom:24px">
      <p style="font-size:14px;font-weight:700;color:#1a3a6b;margin:0 0 16px">How to get started:</p>
      <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:12px">
        <tr>
          ...
          <td style="padding-top:6px"><p style="font-size:14px;color:#374151;margin:0">Upload photos of your item</p></td>
        </tr>
      </table>
      <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:12px">
        <tr>
          ...
          <td style="padding-top:6px"><p style="font-size:14px;color:#374151;margin:0">Fill in the lot details</p></td>
        </tr>
      </table>
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td style="padding-top:6px"><p style="font-size:14px;color:#374151;margin:0">Submit — our team reviews it and it goes live within 24h</p></td>
        </tr>
      </table>
    </div>
    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px">
      <tr><td align="center">
        <a href="<?php echo e(url('/vendor')); ?>" style="background:#1a3a6b;color:#fff;padding:14px 32px;border-radius:8px;font-size:15px;font-weight:700;text-decoration:none;display:inline-block">Upload my first lot now</a>
      </td></tr>
    </table>
    <div style="border-top:2px solid #c9a84c;padding-top:20px">
      <p style="font-size:13px;font-weight:700;color:#1a3a6b;margin:0 0 12px">Why RialBids:</p>
      <p style="font-size:13px;color:#374151;margin:0 0 8px">&#10003; Real buyers looking for unique pieces</p>
      <p style="font-size:13px;color:#374151;margin:0 0 8px">&#10003; Get paid directly and securely via Stripe</p>
      <p style="font-size:13px;color:#374151;margin:0 0 8px">&#10003; No subscription — you only pay when you sell</p>
      <p style="font-size:13px;color:#374151;margin:0">&#10003; We support you every step of the way</p>
    </div>
    ...
    <div style="border-top:2px solid #c9a84c;padding-top:20px;margin-top:24px">
      <p style="font-size:14px;font-weight:700;color:#1a3a6b;margin:0 0 16px">Live auctions right now:</p>
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td style="width:50%;padding:0 <?php echo e($loop->first ? '8px 0 0' : '0 0 0 8px'); ?>;vertical-align:top">
            ...
            <img src="<?php echo e(url('storage/'.$s->image_path)); ?>" style="width:100%;height:140px;object-fit:cover;border-radius:8px;display:block">
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <p style="font-size:13px;font-weight:700;color:#1a3a6b;margin:8px 0 4px"><?php echo e($s->title); ?></p>
            <p style="font-size:13px;color:#c9a84c;font-weight:700;margin:0 0 8px">€<?php echo e(number_format($s->current_price,0,',','.')); ?></p>
          </td>
...
</html><?php /**PATH /home/u396549633/domains/rialbids.com/public_html/resources/views/emails/bienvenida_vendor_en.blade.php ENDPATH**/ ?>