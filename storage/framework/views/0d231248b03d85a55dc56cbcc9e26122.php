...
<nav class="nav">
  ...
  <div class="nav-mobile-actions" style="align-items:center;gap:8px;flex-shrink:0">
    ...
    <?php else: ?>
      ...
      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      <a href="<?php echo e(route('profile.index')); ?>" style="width:32px;height:32px;border-radius:50%;background:#1a56db;display:flex;align-items:center;justify-content:center;text-decoration:none">
