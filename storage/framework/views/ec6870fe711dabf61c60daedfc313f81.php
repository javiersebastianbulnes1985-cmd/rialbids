...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;max-width:600px;box-shadow:0 2px 8px rgba(0,0,0,0.08)">
  ...
  <tr><td style="padding:32px">
    ...
    <div style="background:#1a3a6b;border-radius:8px;padding:20px;margin-bottom:24px">
      ...
      <p style="font-size:14px;color:#fff;margin:0"><strong>Contraseña:</strong> <?php echo e($password); ?></p>
    </div>
...
<div style="background:#f5f3ef;border-left:4px solid #c9a84c;border-radius:0 4px 4px 0;padding:20px;margin-bottom:24px">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px">
      <tr><td align="center">
        <a href="<?php echo e(url('/vendor')); ?>" style="background:#1a3a6b;color:#fff;padding:14px 32px;border-radius:8px;font-size:15px;font-weight:700;text-decoration:none;display:inline-block">Subir mi primer lote ahora</a>
      </td></tr>
    </table>
    ...
    <div style="border-top:2px solid #c9a84c;padding-top:20px;margin-top:24px">
      <p style="font-size:14px;font-weight:700;color:#1a3a6b;margin:0 0 16px">Subastas activas ahora mismo:</p>
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
...
</html><?php /**PATH /home/u396549633/domains/rialbids.com/public_html/resources/views/emails/bienvenida_vendor.blade.php ENDPATH**/ ?>