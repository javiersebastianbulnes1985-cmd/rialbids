<?php $__env->startSection('title','Cómo comprar — RialBids'); ?>
...
<div style="max-width:800px;margin:48px auto;padding:0 24px;">
  ...
  <div style="background:#1a56db;border-radius:12px;padding:28px;margin-top:32px;text-align:center;">
    ...
    <a href="<?php echo e(route('home')); ?>" style="display:inline-block;background:#fff;color:#1a56db;padding:12px 28px;border-radius:8px;font-weight:600;text-decoration:none;font-size:14px;">Ver subastas →</a>
  </div>

</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u396549633/domains/rialbids.com/public_html/resources/views/pages/como-comprar.blade.php ENDPATH**/ ?>