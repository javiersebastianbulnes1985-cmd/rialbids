...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;max-width:600px">
  ...
  <tr><td style="padding:32px">
    ...
    <p style="font-size:15px;color:#374151;margin:0 0 24px">Notamos que todavia no hiciste tu primera puja. Estos lotes estan cerrando pronto.</p>

    <div style="background:#f9fafb;border-radius:8px;padding:20px;margin-bottom:24px">
      <p style="font-size:14px;font-weight:700;color:#111;margin:0 0 12px">Subastas que cierran pronto:</p>
...
<?php /**PATH /home/u396549633/domains/rialbids.com/public_html/resources/views/emails/recordatorio_comprador.blade.php ENDPATH**/ ?>