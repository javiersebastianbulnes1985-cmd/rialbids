...
$imgs=[];
if(!empty($auction->image_path))$imgs[]=str_starts_with($auction->image_path,'http')?$auction->image_path:asset('storage/'.$auction->image_path);
if(!empty($auction->image_path_2))$imgs[]=str_starts_with($auction->image_path_2,'http')?$auction->image_path_2:asset('storage/'.$auction->image_path_2);
if(!empty($auction->image_path_3))$imgs[]=str_starts_with($auction->image_path_3,'http')?$auction->image_path_3:asset('storage/'.$auction->image_path_3);
...
<style>
.show-grid{display:grid;grid-template-columns:1fr 360px;gap:28px;align-items:flex-start;}
.show-right{position:sticky;top:76px;}
.show-related{display:grid;grid-template-columns:repeat(4,1fr);gap:16px;}
@media(max-width:768px){.show-grid{grid-template-columns:1fr !important;}.show-right{position:static !important;}.show-related{grid-template-columns:repeat(2,1fr) !important;}}
</style>
<?php $__env->stopPush(); ?>
...
<span style="margin:0 6px;">›</span><span><?php echo e($catName); ?></span>
<span style="margin:0 6px;">›</span><span style="color:#111;"><?php echo e(Str::limit($auction->title,40)); ?></span>
</div>
<div class="show-grid">
<div>
<h1 style="font-size:22px;font-weight:700;color:#111827;margin-bottom:6px;"><?php echo e($auction->title); ?></h1>
...
<img id="main-img" src="<?php echo e($imgs[0]); ?>" style="width:100%;height:100%;object-fit:contain;background:#fff;">
</div>
...
<img src="<?php echo e($img); ?>" onclick="document.getElementById('main-img').src='<?php echo e($img); ?>'" class="thumb-btn" style="width:72px;height:72px;object-fit:cover;border-radius:8px;cursor:pointer;border:2px solid <?php echo e($i==0?'#1a56db':'#e5e7eb'); ?>;">
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($auction->condition)): ?>
<div style="background:#f0fdf4;border:1px solid #86efac;border-radius:8px;padding:10px 16px;margin-bottom:12px;font-size:13px;color:#166534;font-weight:600;"><span>Estado:</span> <?php echo e(ucfirst(str_replace("_"," ",$auction->condition))); ?></div>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<div style="padding:16px 20px;border-bottom:1px solid #f3f4f6;"><h2 style="font-size:14px;font-weight:600;color:#111827;">Detalles del lote</h2></div>
...
<span style="font-size:12px;color:#9ca3af;width:160px;flex-shrink:0;"><?php echo e($k); ?></span>
...
<div style="text-align:center;flex:1;background:#f9fafb;border-radius:8px;padding:10px 4px;"><div id="cd-d" style="font-size:24px;font-weight:700;color:#111827;">--</div><div style="font-size:10px;color:#9ca3af;text-transform:uppercase;margin-top:2px;">Días</div></div>
<div style="color:#d1d5db;font-size:20px;">:</div>
<div style="text-align:center;flex:1;background:#f9fafb;border-radius:8px;padding:10px 4px;"><div id="cd-h" style="font-size:24px;font-weight:700;color:#111827;">--</div><div style="font-size:10px;color:#9ca3af;text-transform:uppercase;margin-top:2px;">Horas</div></div>
<div style="color:#d1d5db;font-size:20px;">:</div>
<div style="text-align:center;flex:1;background:#f9fafb;border-radius:8px;padding:10px 4px;"><div id="cd-m" style="font-size:24px;font-weight:700;color:#111827;">--</div><div style="font-size:10px;color:#9ca3af;text-transform:uppercase;margin-top:2px;">Min</div></div>
<div style="color:#d1d5db;font-size:20px;">:</div>
<div style="text-align:center;flex:1;background:#f9fafb;border-radius:8px;padding:10px 4px;"><div id="cd-s" style="font-size:24px;font-weight:700;color:#111827;">--</div><div style="font-size:10px;color:#9ca3af;text-transform:uppercase;margin-top:2px;">Seg</div></div>
</div>
</div>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<div style="background:#fff;border:1px solid #e5e7eb;border-radius:12px;overflow:hidden;margin-bottom:12px;">
<div style="padding:20px;border-bottom:1px solid #f3f4f6;">
<p style="font-size:11px;color:#9ca3af;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:6px;"><?php echo e($ended ? 'Precio final' : 'Oferta actual'); ?></p>
<p style="font-size:36px;font-weight:700;color:#111827;line-height:1;">€<?php echo e(number_format($cp,0,',','.')); ?></p>
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$ended && !$rm): ?><p style="font-size:12px;color:#f59e0b;margin-top:6px;">⚠ Precio de reserva no alcanzado</p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ended): ?><span style="display:inline-block;margin-top:8px;background:#f3f4f6;color:#6b7280;font-size:12px;font-weight:600;padding:4px 12px;border-radius:20px;">SUBASTA CERRADA</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$ended): ?>
...
<div style="margin-bottom:12px;background:linear-gradient(135deg,#fffbeb 0%,#fef3c7 100%);border:1px solid #f59e0b;border-radius:12px;padding:14px 16px;display:flex;align-items:center;gap:12px">
  ...
  <a href="<?php echo e(route('profile.index')); ?>?tab=perfil" style="background:#f59e0b;color:#fff;padding:8px 16px;border-radius:8px;font-size:12px;font-weight:700;text-decoration:none;white-space:nowrap;flex-shrink:0">Completar →</a>
</div>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<a href="<?php echo e(route('login')); ?>" style="display:block;width:100%;padding:14px;background:#1a56db;color:#fff;border-radius:8px;font-size:15px;font-weight:600;text-align:center;text-decoration:none;">Iniciar sesión</a>
<p style="font-size:12px;color:#9ca3af;margin-top:8px;"><span>¿No tienes cuenta?</span> <a href="<?php echo e(route('register')); ?>" style="color:#1a56db;">Regístrate gratis</a></p>
</div>
<?php elseif(auth()->user()->id === $auction->user_id): ?>
...
<button onclick="document.getElementById('bid-amount').value=<?php echo e($qb); ?>" style="flex:1;padding:9px 4px;border:1.5px solid #e5e7eb;border-radius:8px;background:#fff;font-size:13px;font-weight:600;color:#374151;cursor:pointer;">€<?php echo e(number_format($qb,0,',','.')); ?></button>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
...
<input type="number" id="bid-amount" name="amount" value="<?php echo e($nb); ?>" min="<?php echo e($nb); ?>" step="1" style="width:100%;padding:13px 13px 13px 28px;border:1.5px solid #e5e7eb;border-radius:8px;font-size:16px;font-weight:600;outline:none;">
</div>
<button type="submit" style="width:100%;padding:14px;background:#1a56db;color:#fff;border:none;border-radius:8px;font-size:15px;font-weight:600;cursor:pointer;margin-bottom:8px;">Realizar oferta</button>
<button type="button" onclick="document.getElementById('bid-amount').value=prompt('Ingresa tu puja máxima (€):',document.getElementById('bid-amount').value);this.closest('form').submit();" style="width:100%;padding:11px;background:#fff;color:#1a56db;border:1.5px solid #1a56db;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;margin-bottom:8px;">Fijar puja máxima</button>
</form>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?><div style="background:#f0fdf4;border:1px solid #86efac;color:#166534;padding:10px;border-radius:8px;font-size:13px;text-align:center;margin-top:8px;">✓ <?php echo e(session('success')); ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?><div style="background:#fef2f2;border:1px solid #fca5a5;color:#991b1b;padding:10px;border-radius:8px;font-size:13px;text-align:center;margin-top:8px;"><?php echo e(session('error')); ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<span>🔨 <?php echo e($auction->total_bids??0); ?> ofertas</span><span>🛡 Anti-sniping activo</span>
</div>
</div>
<?php else: ?>
...
<a href="<?php echo e(route('payment.checkout', $auction->id)); ?>" style="display:block;width:100%;padding:14px;background:#111827;color:#fff;border-radius:8px;font-size:15px;font-weight:600;text-align:center;text-decoration:none;margin-bottom:8px;">Proceder al pago →</a>
<?php else: ?>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php else: ?>
<div style="text-align:center;padding:8px 0;"><p style="font-size:14px;color:#6b7280;">Sin ofertas — subasta cerrada</p></div>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
...
<img src="https://upload.wikimedia.org/wikipedia/commons/2/2a/Mastercard-logo.svg" style="height:24px;" alt="Mastercard">
<img src="https://upload.wikimedia.org/wikipedia/commons/5/5e/Visa_Inc._logo.svg" style="height:20px;" alt="Visa">
<img src="https://upload.wikimedia.org/wikipedia/commons/b/b0/Apple_Pay_logo.svg" style="height:20px;" alt="Apple Pay">
<img src="https://upload.wikimedia.org/wikipedia/commons/f/f2/Google_Pay_Logo.svg" style="height:20px;" alt="Google Pay">
</div>
</div>
...
<div style="padding:14px 16px;border-bottom:1px solid #f3f4f6;display:flex;align-items:center;justify-content:space-between;">
  <span style="font-size:13px;font-weight:600;color:#111827;">🔨 Historial de pujas</span>
  <span style="font-size:12px;color:#6b7280;"><?php echo e($bids->count()); ?> ofertas</span>
</div>
...
<?php
  $name = $bid->user->name ?? 'Anónimo';
  $initial = strtoupper(substr($name, 0, 1));
  $isWinner = $loop->first;
?>
<div style="display:flex;justify-content:space-between;align-items:center;padding:11px 16px;border-bottom:1px solid #f9fafb;<?php echo e($isWinner ? 'background:#f0fdf4;' : ''); ?>">
  <div style="display:flex;align-items:center;gap:10px;">
    <div style="width:30px;height:30px;border-radius:50%;background:<?php echo e($isWinner ? '#059669' : '#e5e7eb'); ?>;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;color:<?php echo e($isWinner ? '#fff' : '#6b7280'); ?>;"><?php echo e($initial); ?></div>
    <div>
      <div style="font-size:13px;color:#374151;font-weight:500;"><?php echo e(substr($name,0,1)); ?>***</div>
      <div style="font-size:11px;color:#9ca3af;"><?php echo e($bid->created_at->format('d/m/Y H:i')); ?></div>
    </div>
  </div>
  <div style="text-align:right;">
    <div style="font-size:14px;font-weight:700;color:<?php echo e($isWinner ? '#059669' : '#111827'); ?>;">€<?php echo e(number_format($bid->amount,0,',','.')); ?></div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isWinner): ?><div style="font-size:10px;color:#059669;font-weight:600;">PUJA MÁS ALTA</div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
  </div>
</div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
...
<div style="max-width:1280px;margin:40px auto;padding:0 16px 48px;">
...
<?php
$rimg=null;
if(!empty($rel->image_path)) $rimg=str_starts_with($rel->image_path,'http')?$rel->image_path:asset('storage/'.$rel->image_path);
elseif(!empty($rel->image_path_2)) $rimg=str_starts_with($rel->image_path_2,'http')?$rel->image_path_2:asset('storage/'.$rel->image_path_2);
$rcp=$rel->current_price??$rel->base_price??0;
?>
<a href="<?php echo e(route('auctions.show',$rel->id)); ?>" style="display:block;background:#fff;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;text-decoration:none;">
<div style="aspect-ratio:4/3;background:#f3f4f6;">
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rimg): ?><img src="<?php echo e($rimg); ?>" style="width:100%;height:100%;object-fit:cover;"><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
