...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:12px;overflow:hidden;max-width:600px;box-shadow:0 2px 8px rgba(0,0,0,0.08)">
  ...
  <tr><td style="padding:32px">
    ...
    <div style="background:#1a3a6b;border-radius:8px;padding:20px;margin-bottom:24px">
      ...
      <p style="font-size:14px;color:#fff;margin:0 0 6px"><strong>E-Mail:</strong> <?php echo e($user->email); ?></p>
      <p style="font-size:14px;color:#fff;margin:0"><strong>Passwort:</strong> <?php echo e($password); ?></p>
    </div>
...
<div style="background:#f5f3ef;border-left:4px solid #c9a84c;border-radius:0 4px 4px 0;padding:20px;margin-bottom:24px">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px">
      <tr><td align="center">
        <a href="<?php echo e(url('/vendor')); ?>" style="background:#1a3a6b;color:#fff;padding:14px 32px;border-radius:8px;font-size:15px;font-weight:700;text-decoration:none;display:inline-block">Jetzt mein erstes Los hochladen</a>
      </td></tr>
    </table>
...
</html><?php /**PATH /home/u396549633/domains/rialbids.com/public_html/resources/views/emails/bienvenida_vendor_de.blade.php ENDPATH**/ ?>