...
<div style="max-width:1100px;margin:40px auto;padding:0 20px;">
  ...
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;margin-bottom:32px;">
    <div style="background:#fff;border:1px solid #e5e7eb;border-radius:10px;padding:20px;text-align:center;">
      <p style="font-size:28px;font-weight:700;color:#111827;margin:0;"><?php echo e($stats['total']); ?></p>
    ...
    <div style="background:#fff;border:1px solid #fbbf24;border-radius:10px;padding:20px;text-align:center;">
      <p style="font-size:28px;font-weight:700;color:#f59e0b;margin:0;"><?php echo e($stats['pendiente']); ?></p>
    ...
    <div style="background:#fff;border:1px solid #86efac;border-radius:10px;padding:20px;text-align:center;">
      <p style="font-size:28px;font-weight:700;color:#16a34a;margin:0;"><?php echo e($stats['activo']); ?></p>
      <p style="font-size:12px;color:#6b7280;margin-top:4px;">Activos</p>
    </div>
    <div style="background:#fff;border:1px solid #e5e7eb;border-radius:10px;padding:20px;text-align:center;">
      <p style="font-size:28px;font-weight:700;color:#6b7280;margin:0;"><?php echo e($stats['finalizado']); ?></p>
  ...
  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!auth()->user()->stripe_onboarding_complete): ?>
    <div style="background:#fffbeb;border:1px solid #fbbf24;color:#92400e;padding:16px;border-radius:8px;margin-bottom:20px;font-size:13px;">
      ...
      <a href="<?php echo e(route('vendor.stripe.onboarding')); ?>" style="color:#92400e;font-weight:700;text-decoration:underline;">Configurá tu cuenta Stripe aquí</a>.
    </div>
  <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($auctions->isEmpty()): ?>
    <div style="text-align:center;padding:60px 0;color:#9ca3af;">
      <p style="font-size:16px;">No tenés lotes todavía.</p>
      <a href="<?php echo e(route('vendor.create')); ?>" style="color:#1a56db;font-size:13px;">Crear tu primer lote →</a>
    </div>
  <?php else: ?>
    <div style="background:#fff;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;">
      <table style="width:100%;border-collapse:collapse;">
        ...
        <tbody>
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $auctions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
              $img = null;
            ...
            <tr style="border-bottom:1px solid #f3f4f6;">
              <td style="padding:14px 16px;">
                <a href="<?php echo e(route('auctions.show', $lot->id)); ?>" style="display:flex;align-items:center;gap:12px;text-decoration:none;">
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($img): ?>
                    <img src="<?php echo e($img); ?>" style="width:48px;height:48px;object-fit:cover;border-radius:6px;border:1px solid #e5e7eb;">
                  <?php else: ?>
                  ...
                  <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                  <div>
                    <p style="font-size:13px;font-weight:600;color:#111827;margin:0;"><?php echo e(Str::limit($lot->title, 40)); ?></p>
                    <p style="font-size:11px;color:#9ca3af;margin:2px 0 0;">Lote #<?php echo e(str_pad($lot->id,4,'0',STR_PAD_LEFT)); ?></p>
                  </div>
                </a>
              </td>
              <td style="padding:14px 16px;text-align:center;">
                <span style="background:<?php echo e($statusColor['bg']); ?>;color:<?php echo e($statusColor['color']); ?>;font-size:11px;font-weight:600;padding:4px 10px;border-radius:20px;">
                  <?php echo e($statusColor['label']); ?>

                </span>
              </td>
              <td style="padding:14px 16px;text-align:right;font-size:14px;font-weight:700;color:<?php echo e($lot->total_bids>0?'#16a34a':'#111827'); ?>;">
                €<?php echo e(number_format($cp,0,',','.')); ?>

              </td>
              <td style="padding:14px 16px;text-align:center;font-size:13px;color:#6b7280;">
                <?php echo e($lot->total_bids ?? 0); ?>
              ...
              <td style="padding:14px 16px;text-align:center;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lot->status === 'paid'): ?>
                  <form method="POST" action="<?php echo e(route('vendor.auctions.ship', $lot->id)); ?>">
                    <?php echo csrf_field(); ?>
