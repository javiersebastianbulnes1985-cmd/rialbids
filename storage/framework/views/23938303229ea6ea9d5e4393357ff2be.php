...
<?php $component->withAttributes([]); ?>
  ...
  <a href="<?php echo e(route('auth.google')); ?>" style="display:flex;align-items:center;justify-content:center;gap:10px;width:100%;padding:10px 14px;border:1.5px solid #e5e7eb;border-radius:8px;font-size:14px;font-weight:500;color:#374151;background:#fff;text-decoration:none;margin-bottom:10px;font-family:'Inter',sans-serif;">
    <img src="https://www.google.com/favicon.ico" style="width:18px;height:18px;"> Continuar con Google
  </a>
  <a href="<?php echo e(route('auth.facebook')); ?>" style="display:flex;align-items:center;justify-content:center;gap:10px;width:100%;padding:10px 14px;border:none;border-radius:8px;font-size:14px;font-weight:500;color:#fff;background:#1877f2;text-decoration:none;margin-bottom:16px;font-family:'Inter',sans-serif;">
