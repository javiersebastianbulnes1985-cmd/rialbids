...
<?php $component->withAttributes([]); ?>
  ...
  <div style="display:flex;flex-direction:column;gap:10px;margin-bottom:20px;">
    ...
    <a href="<?php echo e(route('auth.facebook')); ?>" style="display:flex;align-items:center;justify-content:center;gap:10px;padding:11px;border-radius:8px;font-size:14px;font-weight:500;color:#fff;text-decoration:none;background:#1877F2;">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <p style="text-align:center;margin-top:16px;font-size:13px;color:#6b7280;">
      <span>¿No tenés cuenta?</span> <a href="<?php echo e(route('register')); ?>" style="color:#1a56db;font-weight:500;">Registrarse</a>
    </p>
  </form>
